from engine.star.model import Generator
from engine.star.model import Discriminator
...
class Solver(object):
    ...
    def restore_model(self, resume_iters):
        ...
        lg = torch.load(G_path, map_location=lambda storage, loc: storage)
        self.G.load_state_dict(lg,strict=False)

        ld = torch.load(D_path, map_location=lambda storage, loc: storage)
        self.D.load_state_dict(ld,strict=False)
